  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-4">
      <div className="text-center max-w-md mx-auto">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">{t('error_page.title')}</h1>

        <p className="text-gray-600 mb-8 text-lg">{t('error_page.message')}</p>
        ...
        <p className="text-sm text-gray-500 mt-8">{t('error_page.help')}</p>
      </div>
    </div>
  )
}
